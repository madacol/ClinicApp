...
export const exportToWord = async (datosInforme, templateFile = "InformeMedico.docx") => {
  try {
    ...
    // Se asigna el nombre de salida según la plantilla utilizada.
    let outputFileName = "";
    ...
    } else if (templateFile === "FormulaLentes.docx") {
      outputFileName = "FormulaLentes.docx";
    } else {
    ...
    window.alert(
      "Error al exportar a Word. Verifique que los marcadores en la plantilla sean correctos."
    );
  }
};